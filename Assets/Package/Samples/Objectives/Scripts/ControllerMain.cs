...
public class ControllerMain : MonoBehaviour
{
    ...
    // GUI Elements set in the editor.
    ...
    public void Scorm_Message(ScormManager.Event eventType)
    {
        switch (eventType)
        {
    ...
    {
        Debug.Log("SCORM Initialize Complete");
    ...
    {
        Debug.Log("Loading comments from learner");
    ...
    public void ButtonAddInteractionPressed()
    {
        ...
        if (description == "" | weighting == "" | studentResponse == "")
        {                                       // Validate the Input Elements
            if (description == "")
            {
